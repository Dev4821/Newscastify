...
const News= (props)=> {
  ...
  const updateNews=async()=>
    ...
    useEffect(()=>{  document.title = `${capitalizeFirstLetter(props.category)} - News Castify`;
    updateNews();
   ...
   const nextClick= async()=>{
    ...
    return (
      <div className='container my-2'>
        <h2 className='text-center' >{ props.category!=="general" && capitalizeFirstLetter(props.category)} Top Headlines</h2>
           {loading && <Spinner/>}
          {  !loading &&
        <div className="row">
